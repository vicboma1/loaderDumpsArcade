...
int  __cdecl  Hook_iDmacDrvRegisterWrite(int deviceId, DWORD CommandCode, int unused, DWORD *DeviceResult) {
...
DWORD __cdecl Hook_iDmacDrvOpen(int deviceId, LPVOID outBuffer, LPVOID lpSomeFlag) {
...
int __cdecl Hook_iDmacDrvRegisterRead(int DeviceId, DWORD CommandCode, LPVOID OutBuffer, LPVOID DeviceResult) {
...
DWORD __cdecl Hook_iDmacDrvClose(int deviceId, LPVOID lpWriteAccess) {
...
int __cdecl Hook_iDmacDrvDmaRead(int a1, LPVOID lp, UINT_PTR ucb, LPVOID a4) {
...
int __cdecl Hook_iDmacDrvDmaWrite(int a1, LPVOID lp, UINT_PTR ucb, LPVOID a4) {
...
int __cdecl Hook_iDmacDrvRegisterBufferRead(int a1, DWORD BytesReturned, LPVOID lp, UINT_PTR ucb, LPVOID a5) {
...
int __cdecl Hook_iDmacDrvRegisterBufferWrite(int a1, DWORD BytesReturned, LPVOID *lp, UINT_PTR ucb, LPVOID a5) {
...
int __cdecl Hook_iDmacDrvMemoryRead(int a1, DWORD BytesReturned, LPVOID lp, LPVOID a4) {
...
int __cdecl Hook_iDmacDrvMemoryWrite(int a1, DWORD BytesReturned, int a3, LPVOID lp) {
...
int __cdecl Hook_iDmacDrvMemoryReadExt(int a1, DWORD BytesReturned, int a3, LPVOID lp, DWORD nOutBufferSize, LPVOID a6) {
